...
import board
from adafruit_ht16k33.segments import Seg7x4 #if you get an just comment this one and below
from adafruit_matrixkeypad import Matrix_Keypad #this one as well
...
class ModernBombDefusalGUI(QMainWindow):
    ...
    def update_game_state(self):
        ...
        if self.timer._running:
            ...
            if self.is_phase_solved():
                ...
                self.current_phase = self.game_state.check_phase()
    ...
    def is_phase_solved(self):
        ...
        if self.current_phase == 1 and self.toggles._solved:
            return True
        elif self.current_phase == 2 and self.keypad._solved:
            return True
        elif self.current_phase == 3 and self.wires._solved:
            return True
        return False
    ...
    def end_game(self):
        ...
        self.game_status.setText("BOMB DEFUSED!")
        self.game_status.setStyleSheet(
    ...
    def signal_game_over(self):
        ...
        self.game_status.setText("BOMB EXPLODED!")
        self.game_status.setStyleSheet(
